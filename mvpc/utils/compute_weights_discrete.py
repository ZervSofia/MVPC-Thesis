"""
translation of compute.weights.discrete
...
# Index version test-wise deletion 
...
# Identify missingness indicators for x,y,S,W 
...
def compute_weights_discrete(corr_ind, suffstat):
    ...
    # identify missingness indicators for corr_ind
    ...
    for ind_ri in ind_r:
        ...
        # density ratio weights for each row 
        beta = np.zeros(n_tw)
        for i in range(n_tw):
            row = pa_del[i]
